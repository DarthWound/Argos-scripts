...
# Enable "dconf" lines if you want terminal colors customization
...
#dconf write /org/gnome/terminal/legacy/profiles:/:$trpr/bold-color "'#939597'"
...
#dconf write /org/gnome/terminal/legacy/profiles:/:$trpr/bold-color "'#474543'"
